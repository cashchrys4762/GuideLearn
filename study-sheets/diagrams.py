...
""",
    "แยกเวกเตอร์เป็นองค์ประกอบแกน x และ y",
)
...
""",
    "กราฟ v–t: ความชันคือความเร่ง และพื้นที่ใต้กราฟคือการกระจัด",
)
...
""",
    "ตัวอย่างขว้างหินจากหน้าผา โดยใช้สูตร v² = u² + 2as",
)
...
""",
    "วิถีโปรเจคไทล์: ที่จุดสูงสุดยังมี vₓ และใช้เวลา t ร่วมกันระหว่างแกน",
)
...
""",
    "โดรนปล่อยพัสดุ: ใช้แกน y หาเวลา t แล้วนำไปหา sₓ",
)
...
""",
    "การเคลื่อนที่วงกลมสม่ำเสมอ: ขนาดของ v คงที่ แต่ทิศเปลี่ยน จึงมี a_c",
)
...
""",
    "แผนภาพแรงของกล่องบนพื้นราบ: ΣFₓ = F − f = ma และ ΣFᵧ = N − mg = 0",
)
...
""",
    "พื้นเอียง: แยกแกนตามพื้น และถ้าไม่มีเสียดทานจะได้ a = g sinθ",
)
...
""",
    "งาน: ใช้เฉพาะองค์ประกอบของแรงที่ขนานกับการกระจัด",
)
...
""",
    "การอนุรักษ์พลังงานกล: พลังงานศักย์เปลี่ยนรูปเป็นพลังงานจลน์ได้",
)
...
""",
    "สปริงปล่อยมวล: พลังงานศักย์ยืดหยุ่นเปลี่ยนเป็นพลังงานจลน์",
)
...
""",
    "งานจากแรงที่แปรตาม x: W = ∫ F dx ซึ่งเท่ากับพื้นที่ใต้กราฟ",
)
