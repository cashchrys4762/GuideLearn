...
export default function PlanPage() {
  ...
  usePageScript(
    `${t.tools.planTitle}. ${t.tools.planBody}. ${t.missions.pageSummary}`,
    true,
  );
        ...
        <PageMain id="main-content">
          <div className="mb-12 flex flex-col items-center justify-between gap-6 md:flex-row md:items-end">
            <div>
              ...
              <p className="font-body-md text-body-md text-on-surface-variant mb-3 max-w-xl">
                {t.tools.planBody}
              </p>
              <p className="font-body-lg text-body-lg text-on-surface-variant flex items-center gap-2">
                <Icon name="school" />
                {t.missions.faculty} · {t.missions.university}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 gap-base md:grid-cols-3 md:gap-gutter" role="list">
              {[
                ...
                <div
                  ...
                  className={`cloud-shadow group relative overflow-hidden rounded-[24px] bg-white transition-transform duration-300 hover:-translate-y-1 ${
          ...
          <div className="mb-section-gap grid grid-cols-1 gap-gutter lg:grid-cols-2">
            <section
              className="cloud-shadow relative overflow-hidden rounded-[24px] bg-white p-6 md:p-8"
              ...
              <div className="relative z-10 space-y-3" role="list">
                {requirements.map((item) => (
                  ...
                  >
                    ...
                    <div
                      aria-hidden
                      className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full border-2 bg-white transition-colors ${
                        item.done
                    ...
                    >
                      {item.done && <Icon name="check" className="text-sm text-white" />}
                    </div>
                    <span
            ...
            <section
              className="cloud-shadow-lg rounded-[24px] bg-white p-6 md:p-8"
